...
export const PRESET_REGISTRY: OfficialSpecPreset[] = [
  ...
  },
  {
    ...
    verified: false,
    notes:
      "Placeholder for UPSC photograph workflow. Official specification awaiting verification against the current application portal/notification before it should be treated as authoritative.",
  },
  {
    id: "upsc-cse-signature",
    exam: "UPSC CSE",
    organization: "Union Public Service Commission",
    documentType: "signature",
    dimensions: { width: 4.5, height: 2.0, unit: "cm" },
    ...
    notificationYear: 2026,
    verified: false,
    notes: "Placeholder for UPSC signature workflow. Official specification awaiting verification.",
  },
  {
    id: "jee-main-photo",
    exam: "JEE Main",
    ...
    notificationYear: 2026,
    verified: false,
    notes: "Placeholder for JEE Main photograph workflow. Official specification awaiting verification.",
  },
  {
    ...
    notificationYear: 2026,
    verified: false,
    notes: "Placeholder for JEE Main signature workflow. Official specification awaiting verification.",
  },
  {
    id: "gate-photo",
    exam: "GATE",
    organization: "IISc/IIT GATE Organising Institute",
    documentType: "photo",
    dimensions: { width: 3.5, height: 4.5, unit: "cm" },
    kbMin: 5,
    kbMax: 200,
    ...
    backgroundColor: "white",
    allowDownscale: false,
    sourceUrl: "https://gate2026.iisc.ac.in",
    notificationYear: 2026,
    verified: false,
    notes: "Placeholder for GATE photograph workflow. Official specification awaiting verification.",
  },
  {
    id: "gate-signature",
    exam: "GATE",
    organization: "IISc/IIT GATE Organising Institute",
    documentType: "signature",
    dimensions: { width: 4.5, height: 1.5, unit: "cm" },
    kbMin: 5,
    kbMax: 200,
    acceptedFormats: ["jpeg"],
    preferredFormat: "jpeg",
    ...
    notificationYear: 2026,
    verified: false,
    notes: "Placeholder for GATE signature workflow. Official specification awaiting verification.",
  },
  {
    id: "cuet-ug-photo",
    exam: "CUET UG",
    ...
    notificationYear: 2026,
    verified: false,
    notes: "Placeholder for CUET UG photograph workflow. Official specification awaiting verification.",
  },
  {
    id: "cuet-ug-signature",
    exam: "CUET UG",
    organization: "National Testing Agency (NTA)",
    documentType: "signature",
    dimensions: { width: 3.5, height: 1.5, unit: "cm" },
    ...
    notificationYear: 2026,
    verified: false,
    notes: "Placeholder for CUET UG signature workflow. Official specification awaiting verification.",
  },
]
