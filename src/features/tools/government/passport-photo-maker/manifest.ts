...
export const definition: ToolDefinition = {
  ...
  shortDescription:
    "Create a compliant Indian passport photograph from any upload — sized to the 3.5×3.5 cm requirement with a clean white background.",
  longDescription:
    "Upload a photo and this tool sizes it to the official Indian passport photograph dimensions (3.5 cm × 3.5 cm, white background). Physical dimensions are resolved to pixels at a selectable DPI, then the file is compressed to the required range. Validation is run in-browser and the result tells you honestly whether it meets the specification.",
  schemaType: "Utility",

  sections: [
    {
      heading: "Physical size done right",
      body: "Passport photos are specified in centimetres, not pixels. This tool converts 3.5×3.5 cm to pixels at your chosen DPI (300 by default), producing a physically correct print file.",
    },
    {
  ...
  faq: [
    {
      ...
      answer: "3.5 cm × 3.5 cm on a plain white background. The tool resolves this at the DPI you choose.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "3.5×3.5 cm is the commonly cited Passport Seva requirement. Pending confirmation against the official portal it is marked 'awaiting verification'.",
    },
  ],
  howTo: [
